...
#SBATCH --job-name=call_SNPs_Sasha
...
bcftools mpileup --threads 16 -a AD,DP -Ou --max-depth 2000 -f /nfs/turbo/rsbaucom/lab/IP_genome_COGE/Ipomoea_purpurea_headings_fixed.faa  \
-b /gpfs/accounts/rsbaucom_root/rsbaucom0/jlrifkin/IP_WGS_intermediates/Alignment/bam_list.txt | bcftools call --threads 16 -mv -O z -f gq -o raw_Ipomoea_WGS_2-15-2023.vcf.gz 
